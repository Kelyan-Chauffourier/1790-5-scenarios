...
CAction::CAction(QList<QString> args)
{
...
void CAction::setType(const QString &_type)
{
	type = _type ;
}

void CAction::setName(const QString &_name)
{
	name = _name ;
}

void CAction::setObject(const QString &_object)
{
	object = _object ;
}

void CAction::updateValue(const QString &line, int separator)
{
	QString key ;
	QString value ;
